module.exports = {
    startPage: "https://mauroreisvieira.github.io/redomjs-tailwindcss/",
    docsRepo: "https://github.com/mauroreisvieira/redomjs-tailwindcss/blob/master/",
    version: "1.x",
    theme: {
        colors: {
            primary: "#1cb3ba",
    ...
    topNav: [
        ...
        {
            text: "Github",
            link: "https://github.com/mauroreisvieira/redomjs-tailwindcss/",
            icon:
